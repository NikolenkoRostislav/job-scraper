...
from shared.utils.files import get_static_file
...
def _add_skill_mapping(entry, mappings):
    pattern = _get_pattern(entry.get("aliases", []))
...
def create_skill_mappings_file(infos_path: str, mappings_filename: str):
    _create_mappings_file(infos_path, mappings_filename, _add_skill_mapping)


def create_country_mappings_file(infos_path: str, mappings_filename: str):
    _create_mappings_file(infos_path, mappings_filename, _add_country_mapping)
